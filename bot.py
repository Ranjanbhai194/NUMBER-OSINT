...
L = {
    'en': {'lang': "🌐 Select Language:", 'welcome_premium': "💎 **Premium Required**\n\n📅 Plans:\n• 1 Day – ₹10\n• 5 Days – ₹30\n• 1 Week – ₹35\n• 1 Month – ₹70\n\n🎯 Features:\n📱 Number\n🆔 Aadhaar\n🚗 Vehicle (Normal & Special)", 'buy_premium': "💳 Buy Premium", 'payment_info': "💳 **Pay via UPI**\nUPI: `desi.hacker@ybl`\n📅 Plans: 1D ₹10, 5D ₹30, 1W ₹35, 1M ₹70\n📸 Scan QR below.\nAfter payment, send screenshot to @Cyber_With_Ranjan.", 'already_premium': "🎉 You are already premium!", 'main_menu': "📱 **Main Menu**", 'search': "🔍 Search", 'premium': "💎 Premium", 'number': "📱 Number", 'vehicle': "🚗 Vehicle", 'vehicle_special': "🚘 Vehicle Special", 'aadhaar': "🆔 Aadhaar", 'claim_btn': "🪙 Claim Coin", 'profile_btn': "👤 Profile", 'help_btn': "❓ Help", 'about_btn': "ℹ️ About", 'clear_btn': "🗑️ Clear", 'back': "🔙 Back", 'owner': "👨‍💻 Owner", 'group': "🔗 Group", 'admin_only': "⚠️ You are not authorized.", 'stats_text': "📊 Stats\n👥 Total: {total}\n✅ Active: {access}\n💎 Premium: {premium}\n🪙 Coins: {coins}\n🔍 Searches: {searches}", 'enter_number': "📱 Send 10-digit number:", 'enter_vehicle': "🚗 Send vehicle number:", 'enter_vehicle_special': "🚘 Send vehicle for Special:", 'enter_aadhaar': "🆔 Send 12-digit Aadhaar:", 'coins_left': "🪙 {coins} coins left", 'premium_active': "💎 Premium Active", 'not_premium': "❌ No premium access.", 'follow_insta': "📸 Follow Insta", 'visit_website': "🌐 Visit Website", 'get_coin': "🪙 Get 1 FREE Coin", 'coin_earned': "✅ You earned 1 FREE Coin!", 'already_done': "✅ Already done!", 'follow_visit_required': "⚠️ First follow Insta & visit Website.", 'help': "📖 /start, /menu, /num, /vehicle, /vehiclespecial, /aadhaar, /claim, /premium, /profile, /contact, /clear, /language, /pin, /special, /website", 'profile': "👤 Profile\n🪙 Coins: {coins}\n💎 Premium: {prem}\n🔍 Searches: {searches}", 'about': "🤖 OSINT v3.0\n👨‍💻 @Cyber_With_Ranjan", 'al': "✅ Already claimed today!", 'wt': "⏳ Fetching...", 'nc': "❌ No coins! Claim daily 1 FREE Coin.", 'pin_success': "📌 Message pinned!", 'pin_fail': "❌ Failed to pin. Make me admin with pin permission."},
    'hi': {'lang': "🌐 भाषा चुनें:", 'welcome_premium': "💎 **प्रीमियम आवश्यक**\n📅 प्लान:\n• 1 दिन – ₹10\n• 5 दिन – ₹30\n• 1 सप्ताह – ₹35\n• 1 महीना – ₹70", 'buy_premium': "💳 प्रीमियम खरीदें", 'payment_info': "💳 **UPI से भुगतान करें**\nUPI: `desi.hacker@ybl`\nप्लान: 1D ₹10, 5D ₹30, 1W ₹35, 1M ₹70\n📸 QR स्कैन करें।", 'already_premium': "🎉 आप पहले से प्रीमियम हैं!", 'main_menu': "📱 **मुख्य मेनू**", 'search': "🔍 खोज", 'premium': "💎 प्रीमियम", 'number': "📱 नंबर", 'vehicle': "🚗 वाहन", 'vehicle_special': "🚘 वाहन Special", 'aadhaar': "🆔 आधार", 'claim_btn': "🪙 Coin लें", 'profile_btn': "👤 प्रोफाइल", 'help_btn': "❓ मदद", 'about_btn': "ℹ️ जानकारी", 'clear_btn': "🗑️ साफ करें", 'back': "🔙 वापस", 'owner': "👨‍💻 मालिक", 'group': "🔗 ग्रुप", 'admin_only': "⚠️ आप अधिकृत नहीं।", 'stats_text': "📊 आँकड़े\n👥 कुल: {total}\n✅ सक्रिय: {access}\n💎 प्रीमियम: {premium}\n🪙 Coins: {coins}\n🔍 खोज: {searches}", 'enter_number': "📱 10 अंकों का नंबर भेजें:", 'enter_vehicle': "🚗 वाहन नंबर भेजें:", 'enter_vehicle_special': "🚘 Special के लिए वाहन:", 'enter_aadhaar': "🆔 12 अंकों का आधार:", 'coins_left': "🪙 {coins} coins बचे", 'premium_active': "💎 प्रीमियम सक्रिय", 'not_premium': "❌ प्रीमियम नहीं।", 'follow_insta': "📸 Insta फॉलो", 'visit_website': "🌐 वेबसाइट", 'get_coin': "🪙 1 FREE Coin पाएं", 'coin_earned': "✅ 1 FREE Coin मिला!", 'already_done': "✅ पहले ही किया!", 'follow_visit_required': "⚠️ पहले Insta फॉलो और वेबसाइट विजिट करें।", 'help': "📖 /start, /menu, /num, /vehicle, /vehiclespecial, /aadhaar, /claim, /premium, /profile, /contact, /clear, /language, /pin, /special, /website", 'profile': "👤 प्रोफाइल\n🪙 Coins: {coins}\n💎 प्रीमियम: {prem}\n🔍 खोज: {searches}", 'about': "🤖 OSINT v3.0\n👨‍💻 @Cyber_With_Ranjan", 'al': "✅ आज ले लिए!", 'wt': "⏳ लाया जा रहा...", 'nc': "❌ कोई Coin नहीं! रोजाना 1 FREE Coin लें।", 'pin_success': "📌 संदेश पिन किया!", 'pin_fail': "❌ पिन नहीं कर सका। मुझे पिन अनुमति दें।"},
    'bn': {'lang': "🌐 ভাষা নির্বাচন করুন:", 'welcome_premium': "💎 **প্রিমিয়াম প্রয়োজন**\n📅 প্ল্যান:\n• ১ দিন – ₹১০\n• ৫ দিন – ₹৩০\n• ১ সপ্তাহ – ₹৩৫\n• ১ মাস – ₹৭০", 'buy_premium': "💳 প্রিমিয়াম কিনুন", 'payment_info': "💳 **UPI দিয়ে পে করুন**\nUPI: `desi.hacker@ybl`\nপ্ল্যান: 1D ₹10, 5D ₹30, 1W ₹35, 1M ₹70\n📸 QR স্ক্যান করুন।", 'already_premium': "🎉 আপনি ইতিমধ্যে প্রিমিয়াম!", 'main_menu': "📱 **মেনু**", 'search': "🔍 অনুসন্ধান", 'premium': "💎 প্রিমিয়াম", 'number': "📱 নম্বর", 'vehicle': "🚗 গাড়ি", 'vehicle_special': "🚘 গাড়ি স্পেশাল", 'aadhaar': "🆔 আধার", 'claim_btn': "🪙 Coin দাবি", 'profile_btn': "👤 প্রোফাইল", 'help_btn': "❓ সাহায্য", 'about_btn': "ℹ️ তথ্য", 'clear_btn': "🗑️ মুছুন", 'back': "🔙 ফিরে", 'owner': "👨‍💻 মালিক", 'group': "🔗 গ্রুপ", 'admin_only': "⚠️ আপনার অনুমতি নেই।", 'stats_text': "📊 পরিসংখ্যান\n👥 মোট: {total}\n✅ সক্রিয়: {access}\n💎 প্রিমিয়াম: {premium}\n🪙 Coins: {coins}\n🔍 অনুসন্ধান: {searches}", 'enter_number': "📱 ১০ অঙ্কের নম্বর দিন:", 'enter_vehicle': "🚗 গাড়ির নম্বর দিন:", 'enter_vehicle_special': "🚘 স্পেশালের জন্য গাড়ি:", 'enter_aadhaar': "🆔 ১২ অঙ্কের আধার:", 'coins_left': "🪙 {coins} coins বাকি", 'premium_active': "💎 প্রিমিয়াম সক্রিয়", 'not_premium': "❌ প্রিমিয়াম নয়।", 'follow_insta': "📸 Insta ফলো", 'visit_website': "🌐 ওয়েবসাইট", 'get_coin': "🪙 ১টি FREE Coin পান", 'coin_earned': "✅ ১টি FREE Coin পেলেন!", 'already_done': "✅ আগেই করা!", 'follow_visit_required': "⚠️ আগে Insta ফলো ও ওয়েবসাইট দেখুন।", 'help': "📖 /start, /menu, /num, /vehicle, /vehiclespecial, /aadhaar, /claim, /premium, /profile, /contact, /clear, /language, /pin, /special, /website", 'profile': "👤 প্রোফাইল\n🪙 Coins: {coins}\n💎 প্রিমিয়াম: {prem}\n🔍 অনুসন্ধান: {searches}", 'about': "🤖 OSINT v3.0\n👨‍💻 @Cyber_With_Ranjan", 'al': "✅ আজ দাবি করেছেন!", 'wt': "⏳ আনছি...", 'nc': "❌ Coin নেই! দৈনিক ১টি FREE Coin দাবি করুন।", 'pin_success': "📌 বার্তা পিন করা হয়েছে!", 'pin_fail': "❌ পিন করতে ব্যর্থ। আমাকে পিন অনুমতি দিন।"},
    'mr': {'lang': "🌐 भाषा निवडा:", 'welcome_premium': "💎 **प्रीमियम आवश्यक**\n📅 प्लान:\n• १ दिवस – ₹१०\n• ५ दिवस – ₹३०\n• १ आठवडा – ₹३५\n• १ महिना – ₹७०", 'buy_premium': "💳 प्रीमियम खरेदी", 'payment_info': "💳 **UPI द्वारा पैसे द्या**\nUPI: `desi.hacker@ybl`\nप्लान: 1D ₹10, 5D ₹30, 1W ₹35, 1M ₹70\n📸 QR स्कॅन करा.", 'already_premium': "🎉 तुम्ही आधीच प्रीमियम आहात!", 'main_menu': "📱 **मुख्य मेनू**", 'search': "🔍 शोध", 'premium': "💎 प्रीमियम", 'number': "📱 क्रमांक", 'vehicle': "🚗 वाहन", 'vehicle_special': "🚘 वाहन स्पेशल", 'aadhaar': "🆔 आधार", 'claim_btn': "🪙 Coin मागा", 'profile_btn': "👤 प्रोफाइल", 'help_btn': "❓ मदत", 'about_btn': "ℹ️ माहिती", 'clear_btn': "🗑️ साफ करा", 'back': "🔙 मागे", 'owner': "👨‍💻 मालक", 'group': "🔗 ग्रुप", 'admin_only': "⚠️ तुम्हाला अधिकार नाही.", 'stats_text': "📊 आकडेवारी\n👥 एकूण: {total}\n✅ सक्रिय: {access}\n💎 प्रीमियम: {premium}\n🪙 Coins: {coins}\n🔍 शोध: {searches}", 'enter_number': "📱 १० अंकी क्रमांक पाठवा:", 'enter_vehicle': "🚗 वाहन क्रमांक पाठवा:", 'enter_vehicle_special': "🚘 स्पेशलसाठी वाहन:", 'enter_aadhaar': "🆔 १२ अंकी आधार:", 'coins_left': "🪙 {coins} coins शिल्लक", 'premium_active': "💎 प्रीमियम सक्रिय", 'not_premium': "❌ प्रीमियम नाही.", 'follow_insta': "📸 Insta फॉलो करा", 'visit_website': "🌐 वेबसाइट", 'get_coin': "🪙 १ FREE Coin मिळवा", 'coin_earned': "✅ १ FREE Coin मिळाला!", 'already_done': "✅ आधीच केले!", 'follow_visit_required': "⚠️ प्रथम Insta फॉलो व वेबसाइट पहा.", 'help': "📖 /start, /menu, /num, /vehicle, /vehiclespecial, /aadhaar, /claim, /premium, /profile, /contact, /clear, /language, /pin, /special, /website", 'profile': "👤 प्रोफाइल\n🪙 Coins: {coins}\n💎 प्रीमियम: {prem}\n🔍 शोध: {searches}", 'about': "🤖 OSINT v3.0\n👨‍💻 @Cyber_With_Ranjan", 'al': "✅ आज मागितले!", 'wt': "⏳ आणत आहे...", 'nc': "❌ Coin नाही! दररोज १ FREE Coin मागा.", 'pin_success': "📌 संदेश पिन केला!", 'pin_fail': "❌ पिन करता आला नाही. मला पिन परवानगी द्या."},
    'ur': {'lang': "🌐 زبان منتخب کریں:", 'welcome_premium': "💎 **پریمیم ضروری**\n📅 پلان:\n• ۱ دن – ₹۱۰\n• ۵ دن – ₹۳۰\n• ۱ ہفتہ – ₹۳۵\n• ۱ مہینہ – ₹۷۰", 'buy_premium': "💳 پریمیم خریدیں", 'payment_info': "💳 **UPI سے ادائیگی کریں**\nUPI: `desi.hacker@ybl`\nپلان: 1D ₹10, 5D ₹30, 1W ₹35, 1M ₹70\n📸 QR اسکین کریں۔", 'already_premium': "🎉 آپ پہلے سے پریمیم ہیں!", 'main_menu': "📱 **مین مینو**", 'search': "🔍 تلاش", 'premium': "💎 پریمیم", 'number': "📱 نمبر", 'vehicle': "🚗 گاڑی", 'vehicle_special': "🚘 گاڑی سپیشل", 'aadhaar': "🆔 آدھار", 'claim_btn': "🪙 Coin کا دعوی", 'profile_btn': "👤 پروفائل", 'help_btn': "❓ مدد", 'about_btn': "ℹ️ معلومات", 'clear_btn': "🗑️ صاف کریں", 'back': "🔙 واپس", 'owner': "👨‍💻 مالک", 'group': "🔗 گروپ", 'admin_only': "⚠️ آپ مجاز نہیں۔", 'stats_text': "📊 اعداد و شمار\n👥 کل: {total}\n✅ فعال: {access}\n💎 پریمیم: {premium}\n🪙 Coins: {coins}\n🔍 تلاش: {searches}", 'enter_number': "📱 ۱۰ ہندسی نمبر بھیجیں:", 'enter_vehicle': "🚗 گاڑی کا نمبر بھیجیں:", 'enter_vehicle_special': "🚘 سپیشل کے لیے گاڑی:", 'enter_aadhaar': "🆔 ۱۲ ہندسی آدھار:", 'coins_left': "🪙 {coins} coins باقی", 'premium_active': "💎 پریمیم فعال", 'not_premium': "❌ پریمیم نہیں۔", 'follow_insta': "📸 Insta فالو کریں", 'visit_website': "🌐 ویب سائٹ", 'get_coin': "🪙 ۱ FREE Coin حاصل کریں", 'coin_earned': "✅ ۱ FREE Coin ملا!", 'already_done': "✅ پہلے ہی کیا!", 'follow_visit_required': "⚠️ پہلے Insta فالو اور ویب سائٹ وزٹ کریں۔", 'help': "📖 /start, /menu, /num, /vehicle, /vehiclespecial, /aadhaar, /claim, /premium, /profile, /contact, /clear, /language, /pin, /special, /website", 'profile': "👤 پروفائل\n🪙 Coins: {coins}\n💎 پریمیم: {prem}\n🔍 تلاش: {searches}", 'about': "🤖 OSINT v3.0\n👨‍💻 @Cyber_With_Ranjan", 'al': "✅ آج دعوی کر چکے!", 'wt': "⏳ لا رہا ہوں...", 'nc': "❌ Coin نہیں! روزانہ ۱ FREE Coin حاصل کریں۔", 'pin_success': "📌 پیغام پن کیا!", 'pin_fail': "❌ پن نہیں کر سکا۔ مجھے پن کی اجازت دیں۔"},
    'ta': {'lang': "🌐 மொழியைத் தேர்ந்தெடுக்கவும்:", 'welcome_premium': "💎 **பிரீமியம் தேவை**\n📅 திட்டங்கள்:\n• 1 நாள் – ₹10\n• 5 நாட்கள் – ₹30\n• 1 வாரம் – ₹35\n• 1 மாதம் – ₹70", 'buy_premium': "💳 பிரீமியம் வாங்க", 'payment_info': "💳 **UPI மூலம் செலுத்து**\nUPI: `desi.hacker@ybl`\nதிட்டங்கள்: 1D ₹10, 5D ₹30, 1W ₹35, 1M ₹70\n📸 QR ஸ்கேன் செய்யவும்.", 'already_premium': "🎉 நீங்கள் ஏற்கனவே பிரீமியம்!", 'main_menu': "📱 **முதன்மை மெனு**", 'search': "🔍 தேடு", 'premium': "💎 பிரீமியம்", 'number': "📱 எண்", 'vehicle': "🚗 வாகனம்", 'vehicle_special': "🚘 வாகனம் ஸ்பெஷல்", 'aadhaar': "🆔 ஆதார்", 'claim_btn': "🪙 Coin கோருக", 'profile_btn': "👤 சுயவிவரம்", 'help_btn': "❓ உதவி", 'about_btn': "ℹ️ தகவல்", 'clear_btn': "🗑️ அழி", 'back': "🔙 பின்", 'owner': "👨‍💻 உரிமையாளர்", 'group': "🔗 குழு", 'admin_only': "⚠️ உங்களுக்கு அனுமதி இல்லை.", 'stats_text': "📊 புள்ளிவிவரங்கள்\n👥 மொத்தம்: {total}\n✅ செயலில்: {access}\n💎 பிரீமியம்: {premium}\n🪙 Coins: {coins}\n🔍 தேடல்கள்: {searches}", 'enter_number': "📱 10 இலக்க எண்ணை அனுப்பவும்:", 'enter_vehicle': "🚗 வாகன எண்ணை அனுப்பவும்:", 'enter_vehicle_special': "🚘 ஸ்பெஷலுக்கான வாகனம்:", 'enter_aadhaar': "🆔 12 இலக்க ஆதார்:", 'coins_left': "🪙 {coins} coins மீதம்", 'premium_active': "💎 பிரீமியம் செயலில்", 'not_premium': "❌ பிரீமியம் இல்லை.", 'follow_insta': "📸 Insta பின்தொடரவும்", 'visit_website': "🌐 இணையதளம்", 'get_coin': "🪙 1 FREE Coin பெற", 'coin_earned': "✅ 1 FREE Coin கிடைத்தது!", 'already_done': "✅ ஏற்கனவே செய்துவிட்டீர்கள்!", 'follow_visit_required': "⚠️ முதலில் Insta பின்தொடரவும் & இணையதளத்தை பார்க்கவும்.", 'help': "📖 /start, /menu, /num, /vehicle, /vehiclespecial, /aadhaar, /claim, /premium, /profile, /contact, /clear, /language, /pin, /special, /website", 'profile': "👤 சுயவிவரம்\n🪙 Coins: {coins}\n💎 பிரீமியம்: {prem}\n🔍 தேடல்கள்: {searches}", 'about': "🤖 OSINT v3.0\n👨‍💻 @Cyber_With_Ranjan", 'al': "✅ இன்று கோரியுள்ளீர்கள்!", 'wt': "⏳ பெற்று வருகிறது...", 'nc': "❌ Coin இல்லை! தினமும் 1 FREE Coin பெறவும்.", 'pin_success': "📌 செய்தி பொருத்தப்பட்டது!", 'pin_fail': "❌ பொருத்த முடியவில்லை. எனக்கு பொருத்த அனுமதி கொடுக்கவும்."}
}
...
def ga(i):
    try: c.execute("UPDATE users SET access=1, coins=coins+1 WHERE user_id=?", (i,)); conn.commit()
    except: pass
def gc(i):
    try: c.execute("SELECT coins FROM users WHERE user_id=?", (i,)); r=c.fetchone(); return r[0] if r else 0
    except: return 0

# ✅ FIXED BUG #2: searches track for premium too
def dc(i):
    try:
        if ip(i):
...
# ✅ FIXED BUG #4: sleep 0.5 to avoid flood
def hacker_loading(chat_id, msg_id, query, lang='en', search_type='number'):
    steps = [
        ("📡", "10%", "Initializing connection..."),
        ("🔌", "20%", "Connecting to dark server..."),
        ("🛡️", "30%", "Bypassing firewall..."),
        ("🔐", "40%", "Cracking encryption..."),
        ("💾", "50%", "Accessing database..."),
        ("🔓", "60%", "Decrypting records..."),
        ("🔍", "70%", f"Extracting info for {query}..."),
        ("⚡", "80%", "Fetching personal data..."),
        ("🎯", "90%", "Almost done..."),
        ("✅", "100%", "ACCESS GRANTED")
    ]
    for emoji, percent, text in steps:
        val = int(percent[:-1]) // 10
        bar = "▓" * val + "░" * (10 - val)
        try:
            bot.edit_message_text(
                f"`💻 HACKER MODE ACTIVE`\n`━━━━━━━━━━━━━━━━━━━━━`\n`[{bar}] {percent}`\n`{emoji} > {text}`\n`━━━━━━━━━━━━━━━━━━━━━`\n`🎯 Target: {query}`\n`🔍 Type: {search_type}`\n`⏳ Please wait...`",
...
def premium_start_menu(l):
    ...
    mk.add(InlineKeyboardButton("🌐 Visit Website → cyberwithranjan.in", url=WEBSITE))
...
def search_menu(l):
    mk = InlineKeyboardMarkup(row_width=2)
    mk.add(InlineKeyboardButton(L[l]['number'], callback_data="info"), InlineKeyboardButton(L[l]['vehicle'], callback_data="vehicle_info"), InlineKeyboardButton(L[l]['vehicle_special'], callback_data="vehicle_special_info"), InlineKeyboardButton(L[l]['aadhaar'], callback_data="aadhaar_info"))
...
def premium_btn(l):
    mk = InlineKeyboardMarkup(row_width=2)
    mk.add(InlineKeyboardButton("💳 ₹10 - 1D", callback_data="pay_1day"), InlineKeyboardButton("💳 ₹30 - 5D", callback_data="pay_5days"))
    mk.add(InlineKeyboardButton("💳 ₹35 - 1W", callback_data="pay_7days"), InlineKeyboardButton("💳 ₹70 - 1M", callback_data="pay_30days"))
...
def lang_selection():
    ...
    mk.add(InlineKeyboardButton("🇬🇧 English", callback_data="lang_en"), InlineKeyboardButton("🇮🇳 हिन्दी", callback_data="lang_hi"), InlineKeyboardButton("🇧🇩 বাংলা", callback_data="lang_bn"), InlineKeyboardButton("🇮🇳 मराठी", callback_data="lang_mr"), InlineKeyboardButton("🇵🇰 اُردو", callback_data="lang_ur"), InlineKeyboardButton("🇮🇳 தமிழ்", callback_data="lang_ta"))
    return mk

# ==================== HANDLERS ====================
# ✅ FIXED BUG #1: chat_types=['private'] on all private handlers
...
def get_coin_cb(c):
    ...
    mark_insta(c.from_user.id); mark_website(c.from_user.id); ga(c.from_user.id)
...
def pin_command(m):
    ...
    if m.reply_to_message:
        ...
        except: bot.reply_to(m, "❌ Failed to pin. Make me admin with pin permission.")
    else: bot.reply_to(m, "❌ Reply to a message with /pin to pin it.")

# ==================== PROCESS QUERY (FIXED ORDER) ====================
def process_query(m, q, is_vehicle=False, is_special=False, is_aadhaar=False, is_number_special=False):
    ...
    if not ip(m.from_user.id):
        ...
        if coins <= 0:
            bot.reply_to(m, L[l]['nc'], reply_markup=premium_start_menu(l)); return
    ...
    # ✅ FIXED BUG #3: Fetch data BEFORE animation for better UX
    if is_aadhaar: d = fetch_aadhaar(q)
    elif is_special: d = fetch_vehicle_special(q)
    elif is_vehicle: d = fetch_vehicle(q)
    elif is_number_special: d = fetch_number_special(q)
    ...
    # Admin debug
    if m.from_user.id == ADMIN_ID:
        try: bot.send_message(ADMIN_ID, f"🔍 **RAW API RESPONSE** for `{q}`:\n```json\n{json.dumps(d, indent=2)}\n```", parse_mode='Markdown')
        except: pass
    ...
    if not d:
        try: bot.edit_message_text(f"`❌ ACCESS DENIED`\n\n`> Target: {q}`\n`> Reason: No data found / API error`", m.chat.id, msg.message_id, parse_mode='Markdown')
    ...
    try:
        bot.edit_message_text(f"`✅ ACCESS GRANTED`\n`🎯 Target: {q}`\n{res}", m.chat.id, msg.message_id, parse_mode='Markdown')
        ...
        bot.send_message(m.chat.id, f"Error: {e}"); return
...
def special_cmd(m):
    p=m.text.split()
    if len(p)<2: bot.reply_to(m, "❌ /special 9661756498 (10-digit number)"); return
    phone = p[1].strip()
...
def test_api(m):
    if m.from_user.id != ADMIN_ID: bot.reply_to(m, "❌ Admin only."); return
    parts = m.text.split()
    ...
    else: bot.reply_to(m, "❌ No data or error from API.")
...
def cl2(m):
    ...
    else: bot.reply_to(m, L[l]['al'])

@bot.message_handler(commands=['premium'])
def pm(m):
    l=gl(m.from_user.id)
    if ip(m.from_user.id): bot.reply_to(m, L[l]['already_premium']); return
    try:
        with open(QR_PATH, 'rb') as qr:
            bot.send_photo(m.chat.id, qr, caption=L[l]['welcome_premium'], reply_markup=premium_start_menu(l), parse_mode='Markdown')
    except: bot.send_message(m.chat.id, L[l]['welcome_premium'], reply_markup=premium_start_menu(l), parse_mode='Markdown')
...
if __name__ == "__main__":
    print("🔥 Hacker OSINT Bot v3.0 (BUG-FIXED) Starting...")
    print(f"👨‍💻 Owner: {OWNER}")
    print(f"🌐 Website: {WEBSITE}")
    print("✅ /num → Special API | /special → Normal API")
    print("🎬 Hacker Loading: ON | 📊 Auto JSON: ON")
    print("🪙 1 FREE Coin = 1 Search | 💎 1D₹10 5D₹30 1W₹35 1M₹70")
    print("✅ All bugs fixed — running...")
